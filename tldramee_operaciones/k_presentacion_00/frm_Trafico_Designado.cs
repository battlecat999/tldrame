...
{
    public partial class frm_Trafico_Designado : Form
    {
        #region Field Names
        ...
        public frm_Trafico_Designado()
        {
            InitializeComponent();
        }
        
        private void frm_Trafico_Designado_Load(object sender, EventArgs e)
        {
            RefreshDataGridView();
            timer.Start();
        }
        ...
        private DataTable GetData()
        {
            ...
            dt = lista.Get_Datos("SP_Viajes_Designados", parameters);
            return dt;
        ...
        private void CallPopup(int rowIndex, string columnNameIndex)
        {
            ...
            frm_PopUp_Designa_Viaje_Conceptos._Item = Convert.ToInt32(intItem);
            frm_PopUp_Designa_Viaje_Conceptos._Corredor = Convert.ToInt32(intId_Corredor);
            frm_PopUp_Designa_Viaje_Conceptos._Costo =Convert.ToDecimal( decCosto);
            frm_PopUp_Designa_Viaje_Conceptos._Descripcion_Item = strDescripcion_Item;
            frm_PopUp_Designa_Viaje_Conceptos._IdCliente = Convert.ToInt32(intId_Cliente);
            frm_PopUp_Designa_Viaje_Conceptos._IndTipo = Convert.ToInt32(intIndTipo);
