...
{
    public partial class frm_CorredorTransportes : Form
    {
        ...
        public frm_CorredorTransportes()
        {
            InitializeComponent();
        ...
        private void frm_CorredorTransportes_Load(object sender, EventArgs e)
        {
            //cargarcombos_rutas();
            //cargardataGrid();
            limpiarForm();
        ...
        private void cargardataGrid()
        {
            ...
            o.pAll = 0;//0 es transportistas
            o.IdEmpresa=datos.g_idEmpresa;
            d = o.Corredores_GET("SP_ATC_Select",0,datos.g_idEmpresa );
        ...
        private void cargarcombos_rutas()
        {
            ...
            dt = u.DN_CargarDataTableGral("SP_Transportistas_Get_All", 0,datos.g_idEmpresa  );
            o.CargarComboDataTable(this.cboTransportistas, dt, "id", "descripcion", false, true);
        ...
        private void frm_CorredorTransportes_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void cmdGuadar_Click(object sender, EventArgs e)
        {
            ...
            if (validoForm() == true)
            {
                ...
                dn.Id = Convert.ToInt32(this.cboTransportistas.SelectedValue);
               ...
               //dn.Activo = Convert.ToInt32(this.c_Activo.Checked);
                ...
                dn.DN_asoc_Cliente_Transporte_Corredor("SP_ATC_Insert");
        ...
        private void cmdEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgw.SelectedRows.Count > 0)
                {
                    ...
                    this.cboTransportistas.Text = this.dgw.CurrentRow.Cells[1].Value.ToString();
        ...
        private bool validoForm()
        {
            ...
            if (this.cboTransportistas.SelectedIndex == -1)
            {
                MessageBox.Show("El combo no puede estar vacío", "Atención");
                this.cboTransportistas.Focus();
                return false;
            }
